...
Every figure below is measured, not estimated, and is regenerated by
`python docs/stats.py` — re-run it rather than hand-counting. Measured against
the live `radar.db` on **2026-09-08**:
